...
('superadmin', 'superadmin@homeheaven.com', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '9999999999', '0000', 'ADMIN', TRUE),
...
('admin_user', 'admin@homeheaven.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '9999999998', '0001', 'USER', TRUE),
...
(2, 'Cozy 2BHK Apartment in Andheri', '123 Main Street, Andheri West', 'Mumbai', 'Flat', 25000.00, 850, NULL, 
...
(3, 'Comfortable PG for Girls in Koramangala', '456 Park Road, Koramangala 5th Block', 'Bangalore', 'PG', 8000.00, NULL, '3-sharing', 
...
(2, 'Spacious 3BHK House in Bandra', '789 Hill View, Bandra West', 'Mumbai', 'House', 45000.00, 1500, NULL, 
...
(4, 'Modern Hostel for Students', '321 College Road, Near University', 'Pune', 'Hostel', 6000.00, NULL, '4-sharing', 
...
(3, 'Affordable 1BHK Flat in Whitefield', '555 Tech Park Road, Whitefield', 'Bangalore', 'Flat', 15000.00, 600, NULL, 
...
(5, 'Premium PG for Boys in HSR Layout', '888 Sector 2, HSR Layout', 'Bangalore', 'PG', 9500.00, NULL, '2-sharing', 
...
(1, 3, '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/120.0.0.0'),
(1, 5, '192.168.1.101', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7) Safari/605.1.15'),
(2, 2, '192.168.1.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Firefox/121.0'),
(3, 3, '192.168.1.103', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) Safari/604.1'),
(4, 2, '192.168.1.104', 'Mozilla/5.0 (Linux; Android 13) Chrome/120.0.0.0'),
(5, 5, '192.168.1.105', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Edge/120.0.0.0'),
(6, 3, '192.168.1.106', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7) Chrome/120.0.0.0');
